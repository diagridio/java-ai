...
import io.diagrid.dapr.springai.durable.boot.DaprSpringAiProperties.Retry;
...
class DaprSpringAiPropertiesTest {
  ...
  void maxIterationsDefaultsWhenUnset() {
    assertEquals(
        io.diagrid.dapr.springai.durable.workflow.AgentWorkflow.DEFAULT_MAX_ITERATIONS,
