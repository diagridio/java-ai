 ...
 * chat memory and the Dapr client are on the classpath and {@code diagrid.spring-ai.memory.enabled} is
...
@ConditionalOnProperty(prefix = "diagrid.spring-ai.memory", name = "enabled", havingValue = "true",
    matchIfMissing = true)
