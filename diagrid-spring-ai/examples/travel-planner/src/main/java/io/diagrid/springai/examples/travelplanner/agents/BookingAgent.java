...
import io.diagrid.springai.examples.travelplanner.tools.FlakyApiTools;
import org.springframework.ai.chat.client.ChatClient;
import org.springframework.stereotype.Component;

/**
 * Confirms a travel booking using an unreliable provider tool. The tool throws on every even
 * invocation; because each tool call is a durable activity, the diagrid-spring-ai retry policy retries
